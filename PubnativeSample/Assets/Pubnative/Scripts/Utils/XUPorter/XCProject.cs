...
namespace Pubnative.Utils
{
    public partial class XCProject : System.IDisposable
    {
        ...
        {   
            ...
            if (mod.folders != null)
            {
                ...
                foreach (XCModFolder folder in mod.folders)
                {
                    ...
                    this.AddFolder(absoluteFolderPath, folder.folderFlags, modGroup, (string[]) mod.excludes.ToArray(typeof (string)));
                }
            }
        ...
        // Combine paths; replace Windows path separators with OSX compatible separators
